    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="post" action="{{ route('profile.update.id',Auth::user()->id) }}" autocomplete="off" enctype="multipart/form-data">
                {{-- <form method="post" action="{{'profile.update'}}" autocomplete="off" enctype="multipart/form-data"> --}}
                    <div class="card-body">
                            @csrf
                            @method('put')
                ...
                <div class="card-body">
                    <p class="card-text">
                        <div class="author">
                            ...
                            <a href="#">
                                <img class="avatar" src="{{ asset('user/'.Auth::user()->img) }}" alt="">
